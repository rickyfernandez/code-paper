...
$\mathbf{F}(\mathbf{U})$, defined through the Euler equations, are conviently
...
\end{equation}
%
where $\mathbf{Q}_i$ is the volume integral of $\mathbf{U}_i$ and
...
become a sum over all polygon faces. Furthermore, time is discretize leading to
a finite difference update of the cell's quanitites
%
\begin{equation}
...
\ref{sec.tessellation} respectively will go into detail how these quanities are
estimated.
