...
The problem has a well known analytical self-similar solution; see \citep{Sedov1959} for details. 
...
We follow \citep{Springel2010} and setup a box of unit length with density
\begin{equation}
	\rho = \left\{
      \begin{array}{@{}ll@{}}
            2 & \text{for}\ y < 0.25 \\
