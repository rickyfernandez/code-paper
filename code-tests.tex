...
\begin{figure}
    \begin{center}
        ...
        imparted remains stationary as the cells around it move raidally outward. The cells at
...
\begin{figure}
    \begin{center}
        ...
        both particles remain in their orbital path shown in red signfying the stability
        of the leap frog integrator. Right: Corresponding relative total energy error.
        The total energy remains accuratley conserved as the worst relative error is
        $-1.1\times10^{4}$.}
        \label{fig.two_body}
    \end{center}
\end{figure}
...
when the shock has formed and is traveling outward. We see all profiles adquately follow the
...
discrepency arises from the gravitational work term which ignores the motion of mass
exchanged by adjacent cells. Springel proposed a new formulaton for then energy equation
