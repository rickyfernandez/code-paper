...
classes and methods that we believe will be beneficial for the reader. Moreover, we will
give examples of code snippets for the reader can become more
comfortable with the syntax of the code. As a road map, Figure \ref{fig.phd_design} shows a high level view of the code. As it can be seen, the code consists of six core components:
...
portions of the code. Furthermore, each component may be made up of several more
...
\begin{figure}
    \begin{center}
        ...
        \caption{High level view of the the phd code. The code is compromised of six core components
...
traits that are common throughout the code.
